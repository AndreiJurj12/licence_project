...
import ubb.cscluj.financialforecasting.databinding.FragmentAdminUserProfileBinding
...
class AdminProfileFragment : Fragment() {
    private var _binding: FragmentAdminUserProfileBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdminUserProfileBinding.inflate(inflater, container, false)
    ...
    private fun setupLogoutButton() {
        binding.logoutButton.setOnClickListener {
            ...
            val userToken = (activity as AdminActivity).userToken
            CoroutineScope(Dispatchers.IO).launch {
                ...
                try {
                    ...
                    CoroutineScope(Dispatchers.Main).launch {
                        Handler().postDelayed({
                            (activity as AdminActivity).logoutUser()
                        }, 1000)
                    }
                }
            }
